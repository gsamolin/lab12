...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference("Answer.count") do
      post answers_url, params: { answer: { numbers: @answer.numbers, right_numbers: @answer.right_numbers } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { numbers: @answer.numbers, right_numbers: @answer.right_numbers } }
